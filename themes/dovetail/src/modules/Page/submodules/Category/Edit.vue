  ...
  <admin>
    ...
    <template v-slot:appbar>
      <appbar-action-buttons
        ...
        router-name="pages.categories.index"
        v-model="resource"
    ...
    <page-header :back="{ to: { name: 'pages.categories.index' }, text: trans('Categories') }">
  ...
  methods: {
    ...
    submit (e) {
      ...
      axios.post(
        ...
        this.showSnackbar({
          text: trans('Page Category updated successfully'),
        })

        this.showSuccessbox({
          text: trans(`Updated Page Category ${this.resource.data.name}`),
          buttons: {
            show: {
              code: 'pages.categories.index',
              to: { name: 'pages.categories.index', params: { id: this.resource.data.id } },
              icon: 'mdi-tag-outline',
              text: trans('View All Page Categories'),
            },
            create: {
              code: 'pages.categories.create',
              to: { name: 'pages.categories.create' },
              icon: 'mdi-tag-plus-outline',
              text: trans('Add New Page Category'),
            },
          },
        })
