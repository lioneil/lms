    ...
    <v-card color="transparent" flat>
      <v-card-text class="px-0">
        <div class="d-flex justify-space-between">
          <div>
            <h4 class="mb-3" v-text="trans('Assignment Content')"></h4>
          </div>
            ...
            <div class="text-right mb-3">
              <context-prompt class="d-inline-block">
                ...
                <v-card max-width="280">
                  <v-card-title v-text="trans('Remove Assignment')"></v-card-title>
                  <v-card-text v-text="trans('The Assignment will be permanently removed from storage. Are you sure you want to proceed?')"></v-card-text>
                  <v-card-actions>
                    <v-spacer></v-spacer>
        ...
        <v-card-text class="pa-0">
          <validation-provider
            ...
            <v-file-input
              ...
              outlined
              persistent-hint
              placeholder="Upload Assignment file here"
              prepend-inner-icon="mdi-clipboard-arrow-up-outline"
              show-size
              counter
              v-model="dataset"
              >
      ...
      <input type="hidden" name="metadata[type]" value="AssignmentContent">
