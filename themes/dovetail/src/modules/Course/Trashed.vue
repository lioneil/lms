<template>
  <admin>
    <metatag :title="trans('Trashed Course')"></metatag>
  ...
  methods: {
    ...
    bulkRestoreResources () {
      ...
      axios.patch(
        ...
        this.hideDialog()
        this.showSnackbar({
          text: trans_choice('Course successfully restored', this.tabletoolbar.bulkCount)
        })
      }).catch(err => {
        this.errorDialog({
          width: 400,
    ...
    restoreResource (item) {
      ...
      axios.patch(
        ...
        this.getPaginatedData(null)
        this.showSnackbar({
          text: trans_choice('Course successfully restored', 1)
        })
      })
    },
    ...
    deleteResource (item) {
      ...
      axios.delete(
        ...
        this.hideDialog()
        this.showSnackbar({
          text: trans_choice('Course successfully deleted', 1)
        })
      }).catch(err => {
        this.errorDialog({
          width: 400,
