...
class MailController extends AdminController
{
     ...
     *
     * @param \Mail\Services\MailServiceInterface $service
     */
    ...
    public function index()
    {
        ...
        return view('mail::admin.index')->withResources($resources);
    }
     ...
     *
     * @param  \Mail\Models\Mail $mail
     * @return \Illuminate\Http\Response
     */
    public function show(Mail $mail)
    {
        return view('mail::admin.show')->withResource($mail);
    }
