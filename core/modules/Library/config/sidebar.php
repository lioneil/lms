...
return [
    ...
    'module:library' => [
        'name' => 'module:library',
        'route:name' => 'libraries.index',
        'order' => 50,
        'icon' => 'mdi mdi-folder-multiple-image',
        'text' => 'Media Library',
        'description' => 'Upload and manage media library contents',
        'routes' => [
            'libraries.index', 'libraries.upload',
            'libraries.edit', 'libraries.show', 'libraries.trashed'
        ],
    ],
];
