    ...
    'module:menu' => [
        ...
        'children' => [
            'view-menus' => [
                'name' => 'view-menus',
                'order' => 1,
                'route:name' => 'menus.index',
                'permissions' => ['menus.index'],
                'text' => 'All Menus',
                'description' => 'View the list of all menus',
            ],
            'create-menu' => [
                'name' => 'create-menu',
                'order' => 2,
                'route:name' => 'menus.create',
                'permissions' => ['menus.create', 'menus.store'],
                'text' => 'Create Menu',
            ...
            'trashed-menu' => [
                'name' => 'trashed-menu',
                'order' => 3,
                'route:name' => 'menus.trashed',
                'permissions' => ['menus.trashed'],
                'text' => 'Trashed Menus',
                'description' => 'View list of all menus moved to trash',
            ],
        ],
    ],
];
