    ...
    'module:forum' => [
        ...
        'children' => [
            'view-forums' => [
                'name' => 'view-forums',
                'order' => 1,
                'route:name' => 'forums.index',
                'permissions' => ['forums.index'],
                'text' => 'All Forums',
                'description' => 'View the list of all forums',
            ],
            'create-forum' => [
                'name' => 'create-forum',
                'order' => 2,
                'route:name' => 'forums.create',
                'permissions' => ['forums.create', 'forums.store'],
                'text' => 'Create Forum',
            ...
            'trashed-forum' => [
                'name' => 'trashed-forum',
                'order' => 3,
                'route:name' => 'forums.trashed',
                'permissions' => ['forums.trashed'],
                'text' => 'Trashed Forums',
                'description' => 'View list of all forums moved to trash',
            ],
        ],
    ],
];
