    ...
    'module:classroom' => [
        ...
        'children' => [
            'view-classrooms' => [
                ...
                'order' => 1,
                'route:name' => 'classrooms.index',
                'permissions' => ['classrooms.index'],
                'text' => 'All Classrooms',
            ...
            'create-classroom' => [
                ...
                'order' => 2,
                'route:name' => 'classrooms.create',
                'permissions' => ['classrooms.create', 'classrooms.store'],
                'text' => 'Create Classroom',
                'description' => 'Create new classroom',
            ],
            'trashed-classroom' => [
                'name' => 'trashed-classroom',
                'order' => 3,
                'route:name' => 'classrooms.trashed',
                'permissions' => ['classrooms.trashed'],
                'text' => 'Trashed Classrooms',
                'description' => 'View list of all classrooms moved to trash',
            ],
        ],
    ],
];
