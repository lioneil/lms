    ...
    'module:test' => [
        ...
        'children' => [
            'view-tests' => [
                'name' => 'view-tests',
                'order' => 1,
                'route:name' => 'tests.index',
                'permissions' => ['tests.index'],
                'text' => 'All Tests',
                'description' => 'View the list of all tests',
            ],
            'create-test' => [
                'name' => 'create-test',
                'order' => 2,
                'route:name' => 'tests.create',
                'permissions' => ['tests.create', 'tests.store'],
                'text' => 'Create Test',
            ...
            'trashed-test' => [
                'name' => 'trashed-test',
                'order' => 3,
                'route:name' => 'tests.trashed',
                'permissions' => ['tests.trashed'],
                'text' => 'Trashed Tests',
                'description' => 'View list of all tests moved to trash',
            ],
        ],
    ],
];
