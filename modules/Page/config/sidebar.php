    ...
    'module:page' => [
        ...
        'children' => [
            'view-pages' => [
                ...
                'text' => 'All Pages',
                'description' => 'View the list of all pages',
            ],
            'create-page' => [
                'name' => 'create-page',
                'order' => 2,
                'route:name' => 'pages.create',
                'permissions' => ['pages.create', 'pages.store'],
                'text' => 'Create Page',
            ...
            'trashed-page' => [
                'name' => 'trashed-page',
                'order' => 3,
                'route:name' => 'pages.trashed',
                'permissions' => ['pages.trashed'],
                'text' => 'Trashed Pages',
                'description' => 'View list of all pages moved to trash',
            ],
        ],
    ],
];
