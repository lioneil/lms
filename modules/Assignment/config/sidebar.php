    ...
    'module:assignment' => [
        ...
        'children' => [
            'view-assignments' => [
                ...
                'permissions' => ['assignments.index'],
                'text' => 'All Assignments',
                'description' => 'View the list of all assignments',
            ],
            'create-assignment' => [
                'name' => 'create-assignment',
                'order' => 2,
                'route:name' => 'assignments.create',
                'permissions' => ['assignments.create', 'assignments.store'],
                'text' => 'Create Assignment',
                'description' => 'Create new assignment',
            ],
            'trashed-assignment' => [
                'name' => 'trashed-assignment',
                'order' => 3,
                'route:name' => 'assignments.trashed',
                'permissions' => ['assignments.trashed'],
                'text' => 'Trashed Assignments',
                'description' => 'View list of all assignments moved to trash',
            ],
        ],
    ],
];
