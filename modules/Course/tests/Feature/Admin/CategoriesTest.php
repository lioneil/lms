...
class CategoriesTest extends TestCase
{
    ...
    public function a_super_user_can_view_a_paginated_list_of_all_categories()
    {
        ...
        // Actions
        $response = $this->get(route('courses.categories.index'));

        // Assertions
        $response->assertSuccessful()
                 ->assertViewHas('resources')
                 ->assertViewIs('course::categories.index')
    ...
    public function a_super_user_can_view_a_paginated_list_of_all_trashed_categories()
    {
        ...
        // Actions
        $response = $this->get(route('courses.categories.trashed'));

        // Assertions
        $response->assertSuccessful()
                 ->assertViewHas('resources')
                 ->assertViewIs('course::categories.trashed')
     ...
     * @return void
     */
    public function a_super_user_can_visit_a_category_course()
    {
        // Arrangements
        $this->actingAs($user = $this->superAdmin);
        ...
        // Actions
        $response = $this->get(route('courses.categories.show', $category->getKey()));
        $actual = $response->original->resource;

        // Assertions
        $response->assertSuccessful()
                 ->assertViewHas('resource')
                 ->assertViewIs('course::categories.show')
     ...
     * @return void
     */
    public function a_super_user_can_visit_the_create_category_course()
    {
        // Arrangements
        $this->actingAs($user = $this->superAdmin);

        // Actions
        $response = $this->get(route('courses.categories.create'));

        // Assertions
        $response->assertSuccessful()
                 ->assertViewHas('service')
                 ->assertViewIs('course::categories.create')
     ...
     * @return void
     */
    public function a_super_user_can_visit_the_edit_category_course()
    {
        // Arrangements
        $this->actingAs($user = $this->superAdmin);
        ...
        // Actions
        $response = $this->get(route('courses.categories.edit', $category->getKey()));

        // Assertions
        $response->assertSuccessful()
                 ->assertViewHas('service')
                 ->assertViewHas('resource')
                 ->assertViewIs('course::categories.edit')
    ...
    public function a_super_user_can_restore_a_category()
    {
        ...
        // Actions
        $response = $this->patch(route('courses.categories.restore', $category->getKey()), [], ['HTTP_REFERER' => route('courses.categories.trashed')]);
        $category = $this->service->find($category->getKey());

        // Assertions
        $response->assertRedirect(route('courses.categories.trashed'));
    ...
    public function a_super_user_can_restore_multiple_categories()
    {
        ...
        $response = $this->patch(route('courses.categories.restore'), $attributes, ['HTTP_REFERER' => route('courses.categories.trashed')]);
    ...
    public function a_super_user_can_update_a_category()
    {
        ...
        $response = $this->put(route('courses.categories.update', $category->getKey()), $attributes);

        // Assertions
        $response->assertRedirect(route('courses.categories.show', $category->getKey()));
    ...
    public function a_super_user_can_soft_delete_a_category()
    {
        ...
        $response = $this->delete(
            route('courses.categories.destroy', $category->getKey()), [], ['HTTP_REFERER' => route('courses.categories.index')]
        );

        // Assertions
        $response->assertRedirect(route('courses.categories.index'));
    ...
    public function a_super_user_can_soft_delete_multiple_categories()
    {
        ...
        // Actions
        $attributes = ['id' => $categories->pluck('id')->toArray()];
        $response = $this->delete(route('courses.categories.destroy', $single = 'false'), $attributes);
    ...
    public function a_super_user_can_permanently_delete_an_category()
    {
        ...
        // Actions
        $response = $this->delete(
            route('courses.categories.delete', $category->getKey()), [],
            ['HTTP_REFERER' => route('courses.categories.trashed')]
        );
    ...
    public function a_super_user_can_permanently_delete_multiple_categories()
    {
        ...
        $attributes = ['id' => $categories->pluck('id')->toArray()];
        $response = $this->delete(
            route('courses.categories.delete'), $attributes, ['HTTP_REFERER' => route('courses.categories.trashed')]
        );
    ...
    public function a_super_user_can_store_an_category_to_database()
    {
        ...
        $response = $this->post(route('courses.categories.store'), $attributes);
     ...
     * @return void
     */
    public function a_user_can_visit_the_create_forum_course()
    {
        // Arrangements
     ...
     * @return void
     */
    public function a_user_cannot_edit_others_courses_on_the_show_category_course()
    {
        // Arrangements
     ...
     * @return void
     */
    public function a_user_can_only_visit_their_owned_edit_category_course()
    {
        // Arrangements
     ...
     * @return void
     */
    public function a_user_cannot_visit_others_edit_category_course()
    {
        // Arrangements
    ...
    public function a_user_can_only_restore_owned_category()
    {
        ...
        // Actions
        $response = $this->patch(
            route('courses.categories.restore', $category->getKey()), [], ['HTTP_REFERER' => route('courses.categories.trashed')]
        );
        $category = $this->service->find($category->getKey());
    ...
    public function a_user_can_only_restore_owned_multiple_courses()
    {
        ...
        $attributes = ['id' => $categories->pluck('id')->toArray()];
        $response = $this->patch(
            route('courses.categories.restore'), $attributes, ['HTTP_REFERER' => route('courses.categories.trashed')]
        );
    ...
    public function a_user_can_only_soft_delete_owned_category()
    {
        ...
        // Actions
        $response = $this->delete(route('courses.categories.destroy', $category->getKey()));
    ...
    public function a_user_can_only_multiple_soft_delete_owned_categories()
    {
        ...
        $attributes = ['id' => $categories->pluck('id')->toArray()];
        $response = $this->delete(
            route('courses.categories.destroy', '@null'), $attributes, ['HTTP_REFERER' => route('courses.categories.index')]
        );
        $categories = $this->service->withTrashed()->whereIn('id', $categories->pluck('id')->toArray())->get();
    ...
    public function a_user_cannot_soft_delete_multiple_others_categories()
    {
        ...
        $attributes = ['id' => $categories->pluck('id')->toArray()];
        $response = $this->delete(
            route('courses.categories.destroy', '@null'), $attributes, ['HTTP_REFERER' => route('courses.categories.trashed')]
        );
    ...
    public function a_user_can_only_permanently_delete_owned_category()
    {
        ...
        // Actions
        $response = $this->delete(
            route('courses.categories.delete', $category->getKey()), [], ['HTTP_REFERER' => route('courses.categories.trashed')]
        );
