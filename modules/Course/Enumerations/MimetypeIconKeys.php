...
abstract class MimetypeIconKeys
{
    const MDI_SECTION = 'mdi mdi-format-quote-open-outline';
    ...
    const MDI_SCORM = 'mdi mdi-book-play-outline';
    ...
    const MDI_EXAM = 'mdi mdi-ballot-outline';

    const MDI_PDF = 'mdi mdi-file-pdf-outline';
    const MDI_DOCUMENT = 'mdi mdi-file-document-outline';
    const MDI_PRESENTATION = 'mdi mdi-presentation';

    const MDI_FILE = 'mdi mdi-file-outline';
    const MDI_ASSIGNMENT = 'mdi mdi-clipboard-arrow-up-outline';
    ...
    const MDI_VIDEO = 'mdi mdi-video-outline';
    const MDI_MP4 = 'mdi mdi-video-outline';
    const MDI_MKV = 'mdi mdi-video-outline';
    const MDI_AVI = 'mdi mdi-video-outline';
    const MDI_MOV = 'mdi mdi-video-outline';
    const MDI_WEBM = 'mdi mdi-video-outline';
    const MDI_MPEG = 'mdi mdi-video-outline';
    const MDI_MPG = 'mdi mdi-video-outline';
    const MDI_OGG = 'mdi mdi-video-outline';
    const MDI_WMV = 'mdi mdi-video-outline';

    const MDI_CSS = 'mdi mdi-language-css3';
    const MDI_EDITOR = 'mdi mdi-format-textbox';
