    ...
    'module:quiz' => [
        ...
        'children' => [
            'view-quizzes' => [
                ...
                'permissions' => ['quizzes.index'],
                'text' => 'All Quizzes',
                'description' => 'View the list of all quizzes',
            ],
            'create-quiz' => [
                'name' => 'create-quiz',
                'order' => 2,
                'route:name' => 'quizzes.create',
                'permissions' => ['quizzes.create', 'quizzes.store'],
                'text' => 'Create Quiz',
            ...
            'trashed-quiz' => [
                'name' => 'trashed-quiz',
                'order' => 3,
                'route:name' => 'quizzes.trashed',
                'permissions' => ['quizzes.trashed'],
                'text' => 'Trashed Quizzes',
                'description' => 'View list of all quizzes moved to trash',
            ],
        ],
    ],
];
