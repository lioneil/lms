    ...
    'module:material' => [
        ...
        'children' => [
            'view-materials' => [
                ...
                'permissions' => ['materials.index'],
                'text' => 'All Materials',
                'description' => 'View the list of all materials',
            ],
            'create-material' => [
                'name' => 'create-material',
                'order' => 2,
                'route:name' => 'materials.create',
                'permissions' => ['materials.create', 'materials.store'],
            ...
            'trashed-material' => [
                ...
                'order' => 3,
                'route:name' => 'materials.trashed',
                'permissions' => ['materials.trashed'],
                'text' => 'Trashed Materials',
                'description' => 'View list of all materials moved to trash',
            ],
        ],
    ],
];
